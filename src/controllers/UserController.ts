...
export class UserController {
    static signup = async (postData: any, req: http.IncomingMessage, res: http.ServerResponse) => {
    ...
    static login = async (postData: any, req: http.IncomingMessage, res: http.ServerResponse) => {
